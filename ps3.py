...
WORDLIST_FILENAME = "wordsmod3.txt"
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:
        if calculate_handlen(hand) == 0:
            print()
            print("You have run out of letters, your score for this hand is", total_score, ".")
            break
        print()
        print("Current hand:", end=" "), display_hand(hand)
        user_input = str(input("Please enter a word using the available letters, or !! to end the game"))
        if user_input == "!!":
    ...
    * Returns the total score for the series of hands
    ...
    while num_hands >= 1:
        ...
        while sub_count >= 1:
            print()
            print("Current hand:", end=" "), display_hand(hand)
            sub_option = input("Would you like to substitute letter? ")
            ...
            if replay_option.lower() == "yes":
                while sub_count >= 1:
                    ...
                    if sub_option.lower() == "yes":
                        ...
                        break
                new_score = play_game(hand, word_list)
